    ...
    <>
        <div className=''>
            ...
            <div className='pt-5 found-card p-4'>
                <h4>ExploreDeals <span className='text-success'> <FontAwesomeIcon icon={faRightToBracket} /> </span> from <span>All Over Country</span></h4>
            </div>
            ...
            <div className='card-color m-4'>
                        ...
                        <div className="card h-100  outline-style " data-aos="zoom-in-up">
                          <img src={mcard1} className="card-img-top" alt="Hollywood Sign on The Hill"/>
                            <div className="card-body">
                                ...
                                <div className='pl-5'>
                                <p className="card-text d-flex justify-content-center align-content-center align-items-center pr-5 ">How we calculate this</p> 
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div  className='p-3'>
                <p className='d-flex justify-content-center align-content-center align-items-center      col-lg-12 '>* All fares above were found in last 8 hours. Fares are round trip/one way. Fares incl. all fuel surcharges, taxes & fees and our service fees. Displayed fares are based on historical data, are subject to change and cannot be guaranteed at the time of booking. See all booking terms and conditions. ref E_h-1Ol3dUW1BzMZZ6o1DQ|omIQIVdSskWa-u43Ao3n6w</p>
                </div>
            </div>
